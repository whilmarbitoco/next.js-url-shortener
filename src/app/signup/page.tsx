            ...
            <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                <form className="space-y-6" onSubmit={(e) => handleSubmit(e)}>
                    ...
                    <div>
                        ...
                        <div className="mt-2">
                            <input onChange={(e) => setName(e.target.value)} name="name" type="text" required className="block w-full rounded-md border-0 p-1.5 shadow-sm text-slate-900" />
                        </div>
                    </div>
                ...
                <p className="mt-10 text-center text-sm text-gray-500">
                    ...
                    <Link href="/login" className="mx-2 font-semibold leading-6 text-indigo-600 hover:text-indigo-500">Login</Link>
                </p>
            </div>
        </div>
    );
